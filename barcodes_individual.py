...
def main():
	...
	pagenum = 1
	while lefttoprint > 0:
		thislabel = barcodes[pagenum-1]
		thisfilename = "out/"+str(pagenum).zfill(5)+".png"
		cv2.imwrite(thisfilename, thislabel)
...
def makeBarcode(myurl, mycaption = ""):
	...
	drawthis.text((205, 40), mycaption, font = ImageFont.truetype('/usr/share/fonts/truetype/msttcorefonts/arial.ttf', 20), fill = (0, 0, 0))
